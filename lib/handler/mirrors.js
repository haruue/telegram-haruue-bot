...
function onGroup(chatId, messageId, bot) {
    let msg = '为避免刷屏，请在私聊中使用此功能哦～'
    bot.sendMessage(chatId, msg, {reply_to_message_id: messageId})
}
        ...
        case '':
            ...
            bot.editMessageText(help, {chat_id: originMessage.chat.id, message_id: originMessage.message_id, reply_markup: {
                inline_keyboard: [
                    ...
                    [new InlineKeyboardButton('Artful (17.10)', 'mirrors-ubuntu-artful')],
                    [new InlineKeyboardButton('Bionic (18.04)', 'mirrors-ubuntu-bionic')],
                ]
            }});
            break;
        case 'trusty':
