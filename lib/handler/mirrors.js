...
//            [new InlineKeyboardButton('Debian', 'mirrors-debian')], 
            [new InlineKeyboardButton('CentOS', 'mirrors-centos')], 
            [new InlineKeyboardButton('Epel', 'mirrors-epel')], 
            [new InlineKeyboardButton('Arch Linux', 'mirrors-archlinux')], 
            [new InlineKeyboardButton('Arch Linux CN', 'mirrors-archlinuxcn')]
        ]
    }});
}
